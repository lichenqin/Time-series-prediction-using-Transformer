...
# 获取数据
origin_data = pd.DataFrame(pd.read_csv('./Data/origin_slice_data.csv', header=None, usecols=[0]))
linear_predict = pd.DataFrame(pd.read_csv('./Data/Linear_predict_data.csv', header=None, usecols=[0]))
RNN_predict = pd.DataFrame(pd.read_csv('./Data/RNN_predict_data.csv', header=None, usecols=[0]))
Attention_predict = pd.DataFrame(pd.read_csv('./Data/Attention_predict_data.csv', header=None, usecols=[0]))
Transformer_predict = pd.DataFrame(pd.read_csv('./Data/Transformer_predict_data.csv', header=None, usecols=[0]))
# Parameter
